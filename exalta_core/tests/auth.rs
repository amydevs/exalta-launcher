...
mod tests {
    ...
    fn test_login_steam() {
        ...
        let _cb = client.register_callback(move |v: ::steamworks::AuthSessionTicketResponse| {
            println!("Got response: {:?}", v.result);
        });
        let _cb = client
            .register_callback(|v: ::steamworks::ValidateAuthTicketResponse| println!("{:?}", v));
        ...
        println!("END");
        runtime
            .block_on(exalta_core::auth::request_account(
